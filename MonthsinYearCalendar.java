import java.util.Scanner;
    ...
    /****
    This program prompts the user to enter a four-digit year 
    (e.g. 2012) and then displays a calendar for each month in that year.
    @paramvalue1 is the year entry
    @return is the calendar for each month in the year
    
    Pre-conditions: year is an four-digit integer type.
    
    Post-conditions: output should be a calendar with dates specified in 
    correct order.
    ****/    

public class MonthsinYearCalendar
{
    /****
    ...
    ****/
    ...
    /****
    The main method below prompts the user to enter a four-digit year 
    ...
    ****/
    ...
    public static void main(String[] args)
    {
        ...
        // Print calendar for all twelve months through a loop
        for (month=1; month <=12; month++)
        {
            System.out.println("");
            printMonthCalendar(month, year); // Print the calendar  
        }
    }
}
